...
class MedBot:
    ...
    def generate_response(self, user_query, prescription_info, visit_info, handle_search, intent, history=None, additional_info = []):
        ...
        input = self.build_prompt(user_query, prescription_info, visit_info, to_retrieve, handle_search, history, additional_info)
        input_text = input[0]
        sources = input[1]
        print(input_text)
